...
def shop_owner_products_data(request,shop_owner_id):
    ...
    if search_query:
        searched_shop_owner_products = shop_owner_add_items.objects.filter(
            shop_user_name=shop_user_name,
            product_name__icontains=search_query
        )
    else:
        searched_shop_owner_products = shop_owner_add_items.objects.filter(shop_user_name=shop_user_name)
    ...
    context = {
                    ...
                    'searched_shop_owner_products':searched_shop_owner_products,
                }
